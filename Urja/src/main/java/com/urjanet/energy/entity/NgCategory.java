...
@Entity
@Table(name = "urja_ng_category")
@SequenceGenerator(name = "idSeqGen", sequenceName = "SEQ_URJA_NG_CATEGORY")
public class NgCategory {
	...
	@ElementCollection
	@CollectionTable(name = "urja_ng_category_childseries", joinColumns = @JoinColumn(name = "ng_category_id"))
