...
@Entity
@Table(name = "urja_coal_category")
@SequenceGenerator(name = "idSeqGen", sequenceName = "SEQ_URJA_COAL_CATEGORY")
public class CoalCategory {
	@Id
	...
	@ElementCollection
	@CollectionTable(name = "urja_coal_category_childseries", joinColumns = @JoinColumn(name = "coal_category_id"))
