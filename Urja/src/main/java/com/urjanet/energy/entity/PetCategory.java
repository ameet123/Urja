...
@Entity
@Table(name = "urja_pet_category")
@SequenceGenerator(name = "idSeqGen", sequenceName = "SEQ_URJA_PET_CATEGORY")
public class PetCategory {
	...
	@ElementCollection
	@CollectionTable(name = "urja_pet_category_childseries", joinColumns = @JoinColumn(name = "pet_category_id"))
