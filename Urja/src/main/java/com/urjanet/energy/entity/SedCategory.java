...
@Entity
@Table(name = "urja_sed_category")
@SequenceGenerator(name = "idSeqGen", sequenceName = "SEQ_URJA_SED_CATEGORY")
public class SedCategory {
	@Id
	...
	@ElementCollection
	@CollectionTable(name = "urja_sed_category_childseries", joinColumns = @JoinColumn(name = "sed_category_id"))
