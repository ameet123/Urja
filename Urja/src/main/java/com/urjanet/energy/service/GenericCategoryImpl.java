...
import com.urjanet.energy.repository.GenericCategoryRepository;
 ...
 *
 */
public abstract class GenericCategoryImpl<T, J extends JpaRepository<T, Long> & GenericCategoryRepository<T>>
		implements GenericCategoryService<T> {
	...
	public GenericCategoryImpl(J genericRepository) {
